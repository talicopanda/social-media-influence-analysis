...
class SimpleTimeSeriesBuilder(TimeSeriesBuilderBase):
    """
        ...
        for user_type_or_id in vars(self.ds)[mapping]:
            ...
            for content_type in self.ds.content_space:
                temp2[content_type.get_representation()] \
                    = self.partition_tweets_specific(user_type_or_id,
    ...
    def partition_tweets_specific(self, user_type_or_id: Union[UserType, int],
                                  content_repr: Any,
