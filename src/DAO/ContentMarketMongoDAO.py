...
class ContentMarketMongoDAO(ContentMarketDAO):
    ...
    def __init__(self, db_type, connection_url, community_db_name, community_info_collection, user_info_collection,
                 ...
                 clean_retweets_of_in_community_collection, clean_retweets_of_out_community_collection, content_market_collection,
        ...
        self.content_market_collection = content_market_collection
    ...
    def load_content_market(self, content_market_name):
        return self.content_market_db[self.content_market_collection].find_one({"name": content_market_name})
    ...
    def write_content_market(self, content_market):
        ...
        self.content_market_db[self.content_market_collection].insert_one(vars(content_market))
