...
def find_tweet_to_retweet_ratios(user_types: Set[UserType], mapping_manager: ContentMappingManager,
                                 retweet_type: str):
...
def plot_tweet_to_retweet_ratios(user_types: Set[UserType], mapping_manager: ContentMappingManager, 
